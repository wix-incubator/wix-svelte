export declare function update_hydrating(val: boolean): void;
...
export declare function children(element: HTMLElement): {
    children: ChildNode[];
    element: HTMLElement;
    next: ChildNode;
    last: ChildNode;
};
export declare function claim_element(nodes: any, name: any, fallback: any, svg: any): any;
...
export declare function query_selector_all(selector: string, parent?: HTMLElement): {
    children: Element[];
    element: HTMLElement;
    next: Element;
    last: ChildNode;
